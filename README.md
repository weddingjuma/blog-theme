...
Custom OpenEMR theme derived from [ghostwriter](https://github.com/roryg/ghostwriter)" theme to the [Hugo](https://gohugo.io) site generator.
...
$ mkdir themes
$ cd themes
$ git clone https://github.com/robertdown/openemr-hugo-theme
```
...
`npm` or `yarn` to install them from `package.json`.
